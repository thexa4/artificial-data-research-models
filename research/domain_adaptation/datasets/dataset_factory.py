...
from domain_adaptation.datasets import mnist_custom
...
def get_dataset(dataset_name,
  ...
  """
  dataset_name_to_module = {'mnist': mnist, 'mnist_custom': mnist_custom, 'mnist_m': mnist_m, 'mnist_artificial': mnist_artificial}
